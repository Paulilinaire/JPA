...
//        System.out.println("Entrer le nom de l'utilisateur : ");
//        String userName = scanner.nextLine();
//        System.out.println("Entrer la tâche de l'utilisateur : ");
...
//
//        //Creation de la task
//        Task task = new Task(userTask);
//
//        if (userDAO.addUser(user) && taskDAO.addTask(task)) {
//            System.out.println("Un utilisateur a bien été créé avec sa tâche associée  !");
//        } else {
//            System.out.println("Erreur");
//        }
//    }
